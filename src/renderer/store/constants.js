...
export const SESSION_GENERATE_HIDDEN_ACCOUNT = 'SESSION_GENERATE_HIDDEN_ACCOUNT';
export const SESSION_GET_HIDDEN_ACCOUNTS = 'SESSION_GET_HIDDEN_ACCOUNTS';
...
export const SESSION_GET_HIDDEN_ACCOUNT_BALANCES = 'SESSION_GET_HIDDEN_ACCOUNT_BALANCES';
