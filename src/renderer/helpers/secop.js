    ...
    return {
      ...
      'con:ProcedureRequestData': {
        ...
        'con:FinancialSettings': {
          ...
          'con:SeriousnessMinWagesCheck': tenderBaseTenderConstant.seriousnessCheck === 'seriousnessMinWagesCheck',
          'con:SeriousnessPercentage': tenderBaseTenderConstant.seriousnessPercentage,
          'con:SeriousnessPercentageCheck': tenderBaseTenderConstant.seriousnessCheck === 'seriousnessPercentageCheck',
